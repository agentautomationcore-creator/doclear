    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6 text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">2. Important disclaimer</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">3. User responsibility</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">4. Free plan</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">5. Pro subscription</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">6. Acceptable use</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">7. Service availability</h2>
