    ...
    <div className="min-h-screen bg-white safe-area-inset-top safe-area-inset-bottom">
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-gray-100 px-4 pt-3 pb-2">
        <div className="flex items-center justify-between mb-3">
          <h1 className="text-xl font-bold text-gray-900">DocLear</h1>
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-100 rounded-xl text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30"
          />
        </div>
