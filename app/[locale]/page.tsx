  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 pt-16 pb-12 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-[#1D1D1F] mb-4 leading-tight">
          {t('hero_title')}
        </h1>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold text-center text-[#1D1D1F] mb-10">
          {t('how_title')}
        </h2>
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          {locales.map((locale) => (
            ...
            >
              ...
              <span className="text-sm text-[#86868B]">{LOCALE_NAMES[locale]}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-[#F5F5F7] py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div className="bg-[#F5F5F7] rounded-2xl p-6 border border-[#D2D2D7]">
              <h3 className="text-xl font-bold text-[#1D1D1F]">{t('free_plan')}</h3>
              <p className="text-3xl font-bold text-[#1D1D1F] my-4">0\u20ac</p>
            ...
            <div className="bg-primary/10 rounded-2xl p-6 border-2 border-primary">
              ...
              <p className="text-3xl font-bold text-[#1D1D1F] my-4">
                {t('pro_price')}
              </p>
      ...
      {/* Footer */}
      <footer className="border-t border-[#D2D2D7] py-6 text-center text-sm text-muted">
