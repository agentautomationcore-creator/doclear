  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <Link
          href="/app"
          className="inline-block bg-primary text-white font-semibold px-8 py-4 rounded-xl text-lg hover:bg-blue-700 transition-colors active:scale-95"
        >
          {t('cta')}
        </Link>
      </section>
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          {locales.map((locale) => (
            ...
            >
              ...
              <span className="text-sm text-gray-700">{LOCALE_NAMES[locale]}</span>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-gray-900">{t('free_plan')}</h3>
              <p className="text-3xl font-bold text-gray-900 my-4">0\u20ac</p>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-100 py-6 text-center text-sm text-muted">
